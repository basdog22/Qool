    ...
    $.fn.yabox.animated = {
        show: function(length) {
            ...
            return function($overlay, $full) {
                $full.find('img').removeAttr('width').removeAttr('height');
				$("<div class='close'></div><span class='closesign'>&times;</span><div class='imgalt'>"+$full.find('img').attr('alt')+"</div>").appendTo($full);
				 $full.center();
				$overlay.show();
                $full.fadeIn(length);
