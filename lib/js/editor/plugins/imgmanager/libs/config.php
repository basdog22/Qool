...
define('UPLOADS_PATH', '..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.WEB_BASE);



defined('UPLOADS_URL') || define('UPLOADS_URL', 'http://'.$_SERVER['HTTP_HOST'].'/'.$_SESSION['QOOL_FOLDER'].WEB_BASE );
